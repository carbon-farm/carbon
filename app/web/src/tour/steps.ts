...
export const TOURS: Record<Audience, TourStep[]> = {
  ...
  ADMINISTRATOR: [
    ...
    { target: '/admin/hariharaa-settings', en: 'Settings: the membership price and the UPI details customers pay to.', te: 'సెట్టింగ్‌లు: సభ్యత్వ ధర, కస్టమర్లు చెల్లించే UPI వివరాలు.' },

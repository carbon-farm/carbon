...
export const strings = {
  ...
  hariharaaStatusNotSubmitted: {
    en: 'Not paid yet — pay below to unlock the shop.',
    te: 'ఇంకా చెల్లించలేదు — షాప్‌ను అన్‌లాక్ చేయడానికి క్రింద చెల్లించండి.',
  },
  ...
  paymentStripNotPaid: { en: 'Payment pending — pay to unlock the shop.', te: 'చెల్లింపు పెండింగ్‌లో ఉంది — షాప్‌ను అన్‌లాక్ చేయడానికి చెల్లించండి.' },
  paymentStripAwaiting: { en: 'Payment submitted — waiting for us to verify it.', te: 'చెల్లింపు సమర్పించబడింది — మేము ధృవీకరించే వరకు వేచి ఉంది.' },
  paymentStripRejected: { en: 'We could not verify your payment — please check and pay again.', te: 'మీ చెల్లింపును ధృవీకరించలేకపోయాము — దయచేసి చూసి మళ్ళీ చెల్లించండి.' },
  paymentStripExpired: { en: 'Your subscription has expired — renew to keep shopping.', te: 'మీ సభ్యత్వం గడువు ముగిసింది — షాపింగ్ కొనసాగించడానికి పునరుద్ధరించండి.' },

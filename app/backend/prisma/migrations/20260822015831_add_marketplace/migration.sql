...
CREATE TABLE "ProductCategoryMaster" (
    ...
    CONSTRAINT "ProductCategoryMaster_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ProductCategoryMaster_name_key" ON "ProductCategoryMaster"("name");
...
-- CreateIndex
CREATE UNIQUE INDEX "ProductWishlist_productId_userId_key" ON "ProductWishlist"("productId", "userId");

-- AddForeignKey
ALTER TABLE "VendorProfile" ADD CONSTRAINT "VendorProfile_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VendorProfile" ADD CONSTRAINT "VendorProfile_approvedByUserId_fkey" FOREIGN KEY ("approvedByUserId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "ProductCategoryMaster"("id") ON DELETE SET NULL ON UPDATE CASCADE;
